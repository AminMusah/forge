  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          // This gap, the container below and the group label collapse as one
          // panel: they have to keep the same duration and curve or their
          // edges visibly tear apart mid-animation.
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "pl-2 py-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)]"
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        // The hover hairline is an ::after and needs its own transition: a
        // pseudo-element never inherits its host's.
        "absolute inset-y-0 z-20 hidden w-4 transition-[background-color,translate] duration-200 ease-in-out group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] after:transition-colors after:duration-150 after:ease-out hover:after:bg-sidebar-border sm:flex ltr:-translate-x-1/2 rtl:-translate-x-1/2",
